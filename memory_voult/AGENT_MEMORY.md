...
- These guidelines ensure standardization, security, scalability, and maintainability, reducing production risks and improving collaboration and long-term system evolution [src: context_1.md, context_23.md, context_30.md]
- Always use proper text encoding and correct language formatting in documentation [src: context_1.md, context_23.md, context_30.md]
- Therefore, the project's API can be reached using the Railway public domain, while VPN endpoint planning must verify UDP-compatible infrastructure. [src: context_1.md, context_23.md, context_30.md]
- README documentation references must use clickable Markdown links, not inline code formatting. [src: context_1.md, context_23.md, context_30.md]
...
- PROJECT_MEMORY#4 => context_1.md, context_23.md, context_30.md
- PROJECT_MEMORY#5 => context_1.md, context_23.md, context_30.md
